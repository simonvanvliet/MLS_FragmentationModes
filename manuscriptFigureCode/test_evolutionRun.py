...
import sys
sys.path.insert(0, '..')
#sys.path.append('/Users/simonvanvliet/ownCloud/MLS_GroupDynamics_shared/Code/')
...
model_par = {
    ...
    "maxPopSize":       0,
    "maxT":             1E4,    # total run time
    "sampleInt":        1E2,    # sampling interval
    "mav_window":       1E2,    # average over this time window
    "rms_window":       1E2,    # calc rms change over this time window
