...
model_par = {
    ...
    "sampleInt":        500,      # sampling interval
    "mav_window":       500,    # average over this time window
    "rms_window":       500,    # calc rms change over this time window
