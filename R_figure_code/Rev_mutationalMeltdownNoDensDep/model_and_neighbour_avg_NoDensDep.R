...
df <- readRDS(here::here("R_figure_code", "Rev_mutationalMeltdownNoDensDep", "data_meltdown_noDensDep_RDS")) 

plot_df <- df %>% 
  group_by(indv_NType, offspr_frac, offspr_size) %>% 
...
saveRDS(object = avg, file = here::here("R_figure_code", "Rev_mutationalMeltdownNoDensDep", "neighbour_avg_NoDensDep_RDS"))
